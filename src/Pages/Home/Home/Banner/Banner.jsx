...
const Banner = () => {
    ...
    return (
        <VantaBackground height='85vh'>
            <div className="relative  md:h-screen md:p-10  mb-20 w-full text-white md:min-h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="flex-1 max-w-4xl md:-mt-15 mx-auto p-8 z-10">
                    ...
                    <h1 className="text-5xl  md:text-4xl lg:text-6xl font-bold leading-tight mb-6 molle-regular-italic">Share Food,Share Hope</h1>
                    ...
                    <div className="flex space-x-4">
                        <button className="flex items-center bg-orange-500 bg-3 hover:bg-orange-600 px-3 text-white font-semibold md:py-3 md:px-6 rounded-full transition duration-100 hover:scale-105 active:scale-95">
                            <span className="mr-2">&rarr;</span>Get Start Today
                        </button>
                        <button className="md:flex items-center bg-white text-black bg-2  hover:bg-green-700 hover:text-white font-semibold py-3 px-6 rounded-full transition duration-100 hover:scale-105 active:scale-95">
                            Learn More
                        </button>
                    </div>
                </div>
